...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-b from-[#0d0d0d] via-[#1a1a1a] to-[#0d0d0d] overflow-hidden pt-16"
    >
      <div
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight pixel-font leading-relaxed">
            ...
            <span className="text-[#d4af37] gold-text">RAIYAN</span>
          </h1>
